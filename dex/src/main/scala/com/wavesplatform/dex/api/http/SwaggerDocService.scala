...
class SwaggerDocService(val apiClasses: Set[Class[_]], override val host: String) extends SwaggerHttpService {
  ...
  override val info: Info = Info(
    description = "The Web Interface to the DCC Matcher Server API",
    version = Version.VersionString,
    title = "DCC Matcher Server",
    license = Some(License("MIT License", "https://github.com/Decentral-America/matcher/blob/master/LICENSE"))
  )
